        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mb-12">
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-2xl">Thrive</span>
            </div>
            
            <p className="text-gray-300 leading-relaxed">
              Empowering women through education, mentorship, and community support. 
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Our Mission</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Community Guidelines</Link></li>
              <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Trust & Safety</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold text-lg mb-6">Subscribe to our Newsletter</h4>
            <p className="text-gray-300 mb-4">Stay updated with our latest programs and success stories.</p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © 2024 Thrive Women. All rights reserved.
            </div>
